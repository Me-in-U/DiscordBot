    ...
    async def custom_help(self, interaction: discord.Interaction):
        ...
        categories: dict[str, list[tuple[str, str]]] = {
            "기본": [
                ...
                (
                    "`/채널설정 [기능] [(선택)채널]`",
                    "기념일/도박/음악/유튜브/메이플공지/코덱스리셋/일본지진알림 채널을 지정하거나 해제합니다.",
                ),
                (
                    "`/채널설정확인`",
                    "현재 설정된 기념일/도박/음악/유튜브/메이플공지/코덱스리셋/일본지진알림 채널을 확인합니다.",
                ),
                (
                    "`/기념일업데이트`",
                ...
                (
                    "`/dday추가 [날짜] [제목] [(선택)지난날짜표시]`",
                    "서버 DDAY를 추가합니다. 날짜 예: 2026-06-04",
                ),
                (
                    "`/dday삭제`",
                    "서버 DDAY 목록에서 선택한 항목을 삭제합니다.",
                ),
                ("`/dday목록`", "서버 DDAY 목록을 임베드로 보여줍니다."),
            ],
            "채팅": [
                ("`/채팅` [텍스트]", "봇이 대신 메시지를 전송합니다."),
                (
                    "`/요약`",
                    "현재 채널의 최근 유튜브 링크 10개 제목을 보여주고 선택한 항목을 요약합니다.",
                ),
                (
                    "`/유튜브구독 추가 [입력] [(선택)라이브알림] [(선택)영상알림] [(선택)커뮤니티알림]`",
                    "유튜브 채널 URL, ID, @handle 또는 검색어로 라이브/영상/커뮤니티 알림 구독을 추가합니다.",
                ),
                (
                    "`/유튜브구독 알림설정`",
                    "구독별 라이브 알림, 영상 알림, 커뮤니티 알림을 켜거나 끕니다.",
                ),
                (
                    "`/유튜브구독 삭제`",
                    "서버별 유튜브 구독 목록에서 선택한 항목을 삭제합니다.",
                ),
                ("`/유튜브구독 목록`", "서버별 유튜브 구독 목록을 보여줍니다."),
                ("`/대화요약`", "최근 채팅 내용을 요약합니다."),
                ("`/번역 [(선택)내용]`", "최근 채팅을 한국어로 번역합니다."),
                ("`/해석 [(선택)내용]`", "최근 채팅을 해석합니다."),
                ("`/설명 [(선택)내용]`", "최근 채팅이나 이미지를 설명합니다."),
            ],
            "파티": [
            ...
            "랭크": [
                (
                    "`/내전 [(선택)추가할사람] [(선택)뺄사람]`",
                    "현재 음성방 인원으로 롤 내전 레드/블루팀과 포지션을 랜덤 배정합니다.",
                ),
                ("`/솔랭`", "솔로 랭크 정보를 출력합니다."),
                ("`/자랭`", "자유 랭크 정보를 출력합니다."),
            ...
            "검색": [
                ...
                (
                    "`/환율 [기준통화] [대상통화] [(선택)기간]`",
                    "한국은행 ECOS 기준 최신 환율과 기본 30일 그래프를 보여줍니다. (최대 365일)",
                ),
                (
                    "`/외환보유액`",
                    "한국은행 ECOS 기준 최신 외환보유액과 기본 12개월 그래프를 보여줍니다.",
                ),
                (
                    "`/썬데이메이플`",
                    "진행 중인 스페셜 썬데이 메이플 이벤트 본문 이미지를 보여줍니다.",
                ),
                (
                    "`/메이플공지구독 [상태]`",
                    "현재 채널 shortcut으로 메이플스토리 새 공지와 수정 공지 알림을 구독하거나 해제합니다.",
                ),
                (
                    "`/코덱스리셋알림 [상태]`",
                ...
                (
                    "`/지진알림 [상태]`",
                    "일본 M5.5 이상 지진을 알리고 M7.0 이상은 @everyone으로 전송합니다.",
                ),
                ("`/뭐먹지`", "음식 메뉴 하나를 추천합니다."),
            ...
            "음악": [
                ...
                ("`/재생 [검색어]`", "유튜브 URL이나 검색어로 음악을 재생합니다."),
                ("`/정지`", "음악 재생을 중지하고 음성 채널에서 나갑니다."),
                ("`/스킵`", "현재 곡을 넘깁니다."),
                ("`/대기열`", "현재 대기열을 확인합니다."),
                ("`/구간이동 [시간]`", "현재 곡의 재생 위치를 이동합니다. 예: 1:23"),
                ("`/반복`", "현재 곡 반복 모드를 켜거나 끕니다."),
                ("`/대기열삭제 [번호]`", "대기열에서 지정한 곡을 삭제합니다."),
                ("`/대기열비우기`", "대기열을 모두 비웁니다."),
                ("`/대기열이동 [현재번호] [새번호]`", "대기열 곡의 위치를 변경합니다."),
                ("`/셔플`", "대기열 순서를 무작위로 섞습니다."),
